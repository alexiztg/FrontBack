...
router.get('/gym', function(req, res) {
	res.render('gym', {logged: true, assets: helpers.assetsUrl(), url: helpers.url(), pruebas: process.env.AMBIENTE_NODE == 'pruebas'});
});

router.get('/personal', function(req, res) {
	res.render('personal', {logged: true, assets: helpers.assetsUrl(), url: helpers.url(), pruebas: process.env.AMBIENTE_NODE == 'pruebas'});
});

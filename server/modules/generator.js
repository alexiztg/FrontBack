...
var data_types = {
  ...
  '12': `{name: '[[COLUMN_NAME]]', type: 'string', required: [[NULLABLE]], min: 1, max: [[LENGTH]], searchable: false, reportable: true, timestamp: false, id: false, alias: '[[PREFIX]]_[[COLUMN_NAME]]'}`,
      ...
      files.forEach(function (file) {
        ...
        if (file.name == 'data.tpl') {
          ...
          for (var x = 0; x < columns.length; x++) {
            ...
            column = column.replace('[[IDENTITY]]', i.TYPE_NAME.split(' ')[1] && i.TYPE_NAME.split(' ')[1] == 'identity' ? 'true' : 'false')
